...
portals.forEach(function(part, index) {
	...
	document.body.insertBefore(element, player.element);
...
function checkPortalCollision() {
	...
	portals.forEach(portal => {
        ...
        if (
            ...
            playerOffset.left + player.element.offsetWidth > offset.left &&
            playerOffset.top < offset.bottom &&
            playerOffset.top + player.element.offsetHeight > offset.top
        ) { 
